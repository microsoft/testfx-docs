...
Let's say TraitProperty is an attribute that inherits from TestPropertyAttribute. Here is how the test methods are decorated with this attribute:
```csharp
        [TestMethod]
        [TestProperty("TraitProperty","234")]
